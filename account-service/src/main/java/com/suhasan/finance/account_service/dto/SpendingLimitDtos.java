...
public final class SpendingLimitDtos {
 ...
 public record LimitResponse(Long accountId,BigDecimal transferDailyLimit,BigDecimal withdrawalDailyLimit,BigDecimal transferUsedToday,BigDecimal withdrawalUsedToday,BigDecimal pendingTransferDailyLimit,BigDecimal pendingWithdrawalDailyLimit,LocalDateTime pendingEffectiveAt) {}
 public record ReserveResponse(boolean allowed,boolean replay,BigDecimal dailyLimit,BigDecimal dailyUsed,BigDecimal remaining,String reason) {}
